...
(
    ...
    CONSTRAINT UQ_TABLE_TEMPLATES UNIQUE (table_data_type, sequential_number, table_name)
);
...
(
    ...
    CONSTRAINT FK_SUBSECTION_DATA_TEMPLATES_ON_TABLE_TEMPLATES FOREIGN KEY (table_id) REFERENCES table_templates (id)
);

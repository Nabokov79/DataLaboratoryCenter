...
public interface ProtocolReportTemplateMapper {
    ...
    ProtocolReportTemplate mapToNewProtocolReportTemplate(NewProtocolReportTemplateDto protocolDto, ReportingDocumentDto document);
    ...
    @Mapping(source = "protocolDto.userTextAfterHeading", target = "userTextAfterHeading")
    @Mapping(target = "id", ignore = true)
    ProtocolReportTemplate mapToUpdateProtocolReportTemplate(@MappingTarget ProtocolReportTemplate protocol, UpdateProtocolReportTemplateDto protocolDto, ReportingDocumentDto document);

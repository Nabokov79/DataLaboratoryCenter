...
(
    ...
    CONSTRAINT UQ_APPENDICES_TEMPLATES UNIQUE (object_type_id, sequential_number, appendices_name)
);
...
(
    ...
    object_type_id        BIGINT                                  NOT NULL,
    reporting_document_id BIGINT                                  NOT NULL,
    if_than_norm          VARCHAR                                 NOT NULL,
    approaching           VARCHAR                                 NOT NULL,
    equal                 VARCHAR                                 NOT NULL,
    if_less_norm          VARCHAR                                 NOT NULL,
    if_no_norm            VARCHAR                                 NOT NULL,
    CONSTRAINT pk_conclusionTemplate PRIMARY KEY (id),
    CONSTRAINT UQ_CONCLUSION_TEMPLATES UNIQUE (object_type_id, reporting_document_id)
);
...
(
    ...
    sequential_number      INTEGER                                 NOT NULL,
    heading                VARCHAR                                 NOT NULL,
    text_after_heading     VARCHAR                                 NOT NULL,
    conclusion_template_id BIGINT,
    CONSTRAINT pk_reportProtocolTemplate PRIMARY KEY (id),
    CONSTRAINT FK_REPORT_PROTOCOL_TEMPLATES_ON_CONCLUSION_TEMPLATES FOREIGN KEY (conclusion_template_id) REFERENCES conclusion_templates (id)
);
...
CREATE TABLE IF NOT EXISTS SECTION_APPENDICES_TEMPLATES
(
    section_id    BIGINT,
    appendices_id BIGINT,
    CONSTRAINT pk_section_templates_of_appendices_templates PRIMARY KEY (section_id, appendices_id)
);

...
public class CharacteristicsSurveyObjectServiceImpl implements CharacteristicsSurveyObjectService {
    ...
    public List<CharacteristicsSurveyObjectDto> save(String string
        ...
        if (!characteristicsDto.isEmpty()) {
            List<CharacteristicsSurveyObject> characteristics
                                   = repository.saveAll(mapper.mapToNewCharacteristicsSurveyObject(characteristicsDto));
        ...
        return mapper.mapToCharacteristicsSurveyObjectDto(characteristicsDb.values().stream().toList());
    }
    ...
    public List<CharacteristicsSurveyObjectDto> update(List<UpdateCharacteristicsSurveyObjectDto> characteristicsDto) {
        ...
        return mapper.mapToCharacteristicsSurveyObjectDto(
                repository.saveAll(mapper.mapToUpdateCharacteristicsSurveyObject(characteristicsDto))
        );
    }

    @Override
    public List<CharacteristicsSurveyObjectDto> getAll() {
        return mapper.mapToCharacteristicsSurveyObjectDto(repository.findAll());
    }
